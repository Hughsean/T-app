...
pub struct SharedAsyncRwLock<T>(std::sync::Arc<AsyncRwLock<T>>);
pub struct SharedAsyncMutex<T>(std::sync::Arc<AsyncMutex<T>>);
pub struct SharedMutex<T>(std::sync::Arc<std::sync::Mutex<T>>);
pub struct SharedRwLock<T>(std::sync::Arc<std::sync::RwLock<T>>);
